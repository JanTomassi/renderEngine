...
template <>
void
BufferLayout::Push<float> (int count)
{
...
template <>
void
BufferLayout::Push<unsigned int> (int count)
{
  m_Elements.push_back (
      BufferElement{ GL_UNSIGNED_INT, (unsigned int)count, false });
  m_stride += count * BufferElement::GetSizeOfType (GL_UNSIGNED_INT);
}

template <>
void
BufferLayout::Push<unsigned char> (int count)
{
